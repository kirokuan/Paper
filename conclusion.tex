...
the accuracy is not different signifiantly dispite of the various settings of loss function,window size and dimension. In the comparison set, segmented data set outperforms the one without segmentation. 
