...
\begin{subfigure}[b]{1\textwidth}
   ...
   \label{confusion5}
\end{subfigure}
\caption[Confusion Matrix of Siamese-CBOW]{(a) segmented dataset trained with dimension=300, window size=20, loss function hierarchical softmax,
...
\begin{subfigure}[b]{1\textwidth}
   \includegraphics[width=.9\linewidth]{All_seg_d100_w10_softmax_pinyin}
   \caption{}
   \label{confusion4}
\end{subfigure}
