...
It took around 2 days with GPU NVIDIA TITAN X (PASCAL) to finish Siamese-CBOW word-embedding training. The perforamance with epoch 5, 10 are below the baseline. 
